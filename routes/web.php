...
Route::get('/email-veryfy','Frontend\CheckoutController@emailVerify')->name('email.verify');
Route::post('/veryfy-store','Frontend\CheckoutController@verifyStore')->name('verify.store');
...
Route::post('/contatct/store','Frontend\FrontenController@store')->name('contatct.store');
Route::get('/shopping-cart','Frontend\FrontenController@shoppingCart')->name('shopping.cart');
Route::get('/product-list','Frontend\FrontenController@productlist')->name('product.list');
Route::get('/product-category/{category_id}','Frontend\FrontenController@categoryWiseProduct')->name('category.wise.product');
Route::get('/product-brand/{brand_id}','Frontend\FrontenController@brandWiseProduct')->name('brand.wise.product');
Route::get('/product-details/{slug}','Frontend\FrontenController@productDetails')->name('products.details.info');
Route::post('/find-product','Frontend\FrontenController@findProduct')->name('find.product');
Route::get('/get-product','Frontend\FrontenController@getProduct')->name('get.product');
...
Route::prefix('customers')->group(function (){
    ...
    Route::get('/draft/view','Backend\CustomerController@draft')->name('customers.draft.view');
    ...
    Route::prefix('orders')->group(function (){
        ...
        Route::get('/approved/list','Backend\OrderController@approveList')->name('orders.approved.list');
