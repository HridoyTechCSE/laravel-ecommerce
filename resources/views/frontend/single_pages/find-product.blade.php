                        ...
                        <div class="wrap-slick3 flex-sb flex-w">
                            ...
                            <div class="slick3 gallery-lb">
                                ...
                                @foreach($product_sub_images as $img)
                                    <div class="item-slick3" data-thumb="{{url('public/upload/product_images/product_sub_image/'.$img->sub_image)}}">
                                        <div class="wrap-pic-w pos-relative">
                                            <img src="{{url('public/upload/product_images/product_sub_image/'.$img->sub_image)}}" alt="IMG-PRODUCT">

                                            <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="{{url('public/upload/product_images/product_sub_image/'.$img->sub_image)}}">
